    ...
    implements SearchResultsProviding
{
    async getSearchFilters(): Promise<SearchFilter[]> {
        ...
        const searchFiltersQueryDate = Number(
            Application.getState("search-filters-query-date") ?? 0,
        );
        ...
        const chapterCountsFilter: SearchFilter = {
            ...
            placeholder:
                'Give two chapter counts separated by a "-" to give a range',
            value: "",
        };
        ...
        const volumeCountsFilter: SearchFilter = {
            ...
            title: "Volume Counts",
            placeholder:
                'Give two volume counts separated by a "-" to give a range',
            value: "",
        };
    ...
    async getSearchResults(
        ...
        for (const filter of query.filters) {
            switch (filter.id) {
                ...
                case "formats": {
                    const formats = (filter.value ?? {}) as Record<
                        string,
                        "included" | "excluded"
                    >;
                ...
                case "publishing-statuses": {
                    ...
                    for (const publishingStatus of Object.entries(
                        publishingStatuses,
                    )) {
                        switch (publishingStatus[1]) {
                            case "included":
                                includedPublishingStatuses.push(
                                    publishingStatus[0],
                                );
                                break;
                            case "excluded":
                                excludedPublishingStatuses.push(
                                    publishingStatus[0],
                                );
                                break;
                        }
                ...
                case "source-materials": {
                    const sourceMaterials = (filter.value ?? {}) as Record<
                        string,
                        "included"
                    >;

                    for (const sourceMaterial of Object.entries(
                        sourceMaterials,
                    )) {
                ...
                case "start-years": {
                    ...
                    const startYears = (filter.value as string)
                        .split("-")
                        .map((x) => Number(x));
                ...
                case "chapter-counts": {
                    ...
                    const chapterCounts = (filter.value as string)
                        .split("-")
                        .map((x) => Number(x));
                ...
                case "volume-counts": {
                    ...
                    const volumeCounts = (filter.value as string)
                        .split("-")
                        .map((x) => Number(x));
                ...
                case "adult": {
                    const adult = Object.entries(filter.value) as [
                        string,
                        "included" | "excluded",
                    ][];
                ...
                case "doujin": {
                    const doujin = Object.entries(filter.value) as [
                        string,
                        "included" | "excluded",
                    ][];
                ...
                case "tracked-titles": {
                    const trackedTitles = Object.entries(filter.value) as [
                        string,
                        "included" | "excluded",
                    ][];
