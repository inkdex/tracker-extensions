...
export interface MUForumPostModelV1 {
    ...
    reply_to?: {
        post_id?: number;
        post_author?: { author_id?: number; author_name?: string };
    };
...
export interface MUForumTopicListResponseV1 {
    ...
    results?: {
        record?: MUForumTopicModelSearchV1;
        metadata?: { first_post?: MUForumPostModelV1 };
    }[];
}
...
export interface MUListsSearchResponseV1 {
    ...
    results?: {
        ...
        metadata?: { series?: MUSeriesModelSearchV1; user_rating?: number };
    }[];
}
...
export interface MUReleaseModerateResponseV1 {
    ...
    results?: {
        ...
        metadata?: { series?: number; like_releases?: MUReleaseModelV1[] };
    }[];
